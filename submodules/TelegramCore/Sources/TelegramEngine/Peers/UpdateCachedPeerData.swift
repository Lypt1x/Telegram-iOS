                                    ...
                                    switch fullChat {
                                        case let .channelFull(channelFullData):
                                            ...
                                            if let minAvailableMessageId = minAvailableMessageId, minAvailableMessageIdUpdated {
                                                _internal_deleteMessagesInRange(transaction: transaction, mediaBox: postbox.mediaBox, peerId: peerId, namespace: minAvailableMessageId.namespace, minId: 1, maxId: minAvailableMessageId.id)
                                            }
                                        case .chatFull:
                                            break
                                    }
